...
pluralCaseList.push( {plural: "fronts/orders", pascal: "FrontOrder"} )

pluralCaseList.push( {plural: "stores/orders", pascal: "StoreOrder"} )

pluralCaseList.push( {plural: "riders/foodDeliveries", pascal: "RiderFoodDelivery"} )
