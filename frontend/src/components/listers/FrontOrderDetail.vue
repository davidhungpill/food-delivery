<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <Number label="Place" v-model="item.place" :editMode="editMode" @change="change" />
            </div>
            <div>
                <Date label="OrderDateTime" v-model="item.orderDateTime" :editMode="editMode" @change="change" />
            </div>
            <div>
